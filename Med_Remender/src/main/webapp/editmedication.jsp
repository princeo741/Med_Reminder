...
<head>
    ...
    <title>Edit Medication - Medical Reminder App</title>
    <!-- Bootstrap CSS -->
                    ...
                    <form>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="medicationName" name="medicationName" placeholder="Enter medication name" value="Medication Name" readonly>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="dosageAmount">Dosage Amount</label>
                                    <input type="number" class="form-control" id="dosageAmount" name="dosageAmount" placeholder="Enter dosage amount" value="10" required>
                                </div>
                                <div class="form-group col-md-6">
